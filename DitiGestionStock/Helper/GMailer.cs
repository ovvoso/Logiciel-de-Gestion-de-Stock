...
namespace DitiGestionStock.Helper
{
    public class GMailer
    {
        ...
        public void Send()
        {
            ...
            {
                log.WriteDataError("GMailer-Send", ex.ToString());
        ...
        public static void senMail(string destinataire, string subjet, string body)
        {
            try
            {
                GMailer.GmailUsername = "etudiantcompte01@gmail.com";
                GMailer.GmailPassword = "rqbh rpzs ntot suia";
            ...
            {
                Logger.WriteLogSystem("GMailer-senMail", ex.ToString());
            }
        }
        ...
        //            {
        //                e.GetBaseException();
        //                Logger.WriteLogSystem("GMailer-senMail", e.GetBaseException().ToString());
        //            }
        //        }
        //    }
        //}
